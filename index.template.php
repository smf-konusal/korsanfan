...
function template_init()
{
	...
	if (!defined('DEFAULT_BESE_COLOR')){
		define('DEFAULT_BESE_COLOR', '#bd8624');
	}

	if (!defined('DEFAULT_BESE_COLOR_PRIMARY')){
		define('DEFAULT_BESE_COLOR_PRIMARY', '#583c26');
	}
	if (!defined('DEFAULT_BESE_COLOR_SECONDARY')){
		define('DEFAULT_BESE_COLOR_SECONDARY', '#281b0b');
	}
...
function template_body_above()
{
	...
	echo '
	  ...
	  echo '
	  <div id="header_korsanfan">
	  		<img src="' . $settings['images_url'] . '/theme/torch.gif" alt="' . $context['forum_name_html_safe'] . '">
			<a id="logo" href="', $scripturl, '">', empty($context['header_logo_url_html_safe']) ? '<img src="' . $settings['images_url'] . '/theme/logo.png" alt="' . $context['forum_name_html_safe'] . '">' : '<img src="' . $context['header_logo_url_html_safe'] . '" alt="' . $context['forum_name_html_safe'] . '">' ,'</a>

	  		<img src="' . $settings['images_url'] . '/theme/torch.gif" alt="' . $context['forum_name_html_safe'] . '">
	  </div>';
	  echo '<div class="header_alt"></div>';
...
function template_body_below()
{
	...
	echo '<div class="footer_top_korsan"></div>';
	echo '<div id="footer">';
